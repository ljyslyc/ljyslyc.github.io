...
**博客访问地址：[http://ljyslyc.github.io/](http://ljyslyc.github.io/)**。若您喜欢这个新的博客主题，请给我个star以示鼓励吧，欢迎大家使用。
...
```yml
# other links
twitter_username: ljyslyc
126
facebook_username: ljyslyc
.water
...
zhihu_username: ljyslyc

linkedIn_username: ljyslyc
...
若安装了 Foxit 福昕pdf阅读器可能会占用4000端口，关闭 Foxit服务 或切换 jekyll 端口即可解决。详情见文章：[对这个 jekyll 博客主题的改版和重构](http://ljyslyc
.github.io/2016/03/12/jekyll-theme-version-2.0/)
